...
from PyQt6.QtWidgets import QMainWindow, QWidget, QPushButton, QGridLayout, QLabel, QListWidget, QComboBox
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        grid.addWidget(b, 4, 1, Qt.AlignmentFlag.AlignRight)
...
# Ländercodes in Liste aus dem Verzeichnis der Code-Datei einlesen
srcpath = Path(__file__).parent.absolute()
fname = srcpath.joinpath('countries.xml')
tree = ET.parse(fname)
root = tree.getroot()
