...
from PyQt6.QtWidgets import QMainWindow, QWidget, QPushButton, QGridLayout, QLabel, QFileDialog
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        grid.addWidget(b, 3, 1, Qt.AlignmentFlag.AlignRight)
        b = QPushButton('Ende')
        b.clicked.connect(self.quit)
        grid.addWidget(b, 3, 2, Qt.AlignmentFlag.AlignLeft)
