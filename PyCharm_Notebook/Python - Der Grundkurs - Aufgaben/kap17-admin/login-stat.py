...
# Das Beispiel setzt voraus, dass es in MySQL oder MariaDB
# die in dbs.txt aufgezählten Datenbanken gibt und dass diese 
# jeweils eine login-Tabellen mit dem im Buch beschriebenen
# Aufbau haben.
...
# Liste aller Datenbanken aus dbs.txt im lokalen Verzeichnis einlesen
srcpath = Path(__file__).parent.absolute()
fname = srcpath.joinpath('dbs.txt')
